...
export const config = {
	appName: "nextjsproject for Next.js Demo",
	...
	mails: {
		...
		// For production (after domain verification): "noreply@nextjsproject.dev"
		// from: "onboarding@resend.dev",
		from: "7bonus588@gmail.com",
	},
	// Frontend
	ui: {
	...
	contactForm: {
		...
		to: "7bonus588@gmail.com",
		// the subject of the email
		subject: "ProjectThree Contact form message",
	},
	// Payments
	payments: {
